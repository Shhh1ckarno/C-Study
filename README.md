# Описание C#Study
Это увлекательное путешествие в мир в **C#**, где вы сможете изучить все аспекты языка и проверить свои знания. <br> **Главная страница**
<img width="1468" height="784" alt="image" src="https://github.com/user-attachments/assets/6845eb38-5dc9-4b0b-837a-46068ae00009" />
...
## Ключевые реализации
* **Безопасная авторизация** - через access и refresh токены. <br> **Демонстрация формы регистрации**
...
* **Последовательное обучение с закреплением знаний** - каждый небольшой блок теории содержит несколько тестовых заданий для освоения темы. <br> **Пример теории**
  <img width="1468" height="784" alt="image" src="https://github.com/user-attachments/assets/40e0bc44-b610-40d9-b1c1-4bebcc52b278" /> <br> **Пример тестовых заданий с навигацией**
